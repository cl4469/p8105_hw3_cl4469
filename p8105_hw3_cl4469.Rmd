...
nhanes_df |>
  ...
  pivot_wider(
    ...
    knitr::kable()
```
Comment: From this table, we can derived that of the three levels of education, both males and females have the highest percentage with a "high school equivalent", compared to "Less than high school" and "More than high school". And there is no significant difference between number of male and female in education level of “Less than high school” and “More than high school”; however, the number of male in “High school equivalent” is significantly larger than that of women.
